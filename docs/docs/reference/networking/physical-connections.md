...
| `PHY-007` | `sw-mgmt01` | `Port 3` | `lab01` | `2.5GbE RJ45 (lower, vPro)` |
| `PHY-008` | `sw-mgmt01` | `Port 4` | `lab02` | `10GbE RJ45 (upper)` |
| `PHY-009` | `sw-mgmt01` | `Port 5` | `lab02` | `2.5GbE RJ45 (lower, vPro)` |
| `PHY-010` | `sw-mgmt01` | `Port 6` | `lab03` | `10GbE RJ45 (upper)` |
| `PHY-011` | `sw-mgmt01` | `Port 7` | `lab03` | `2.5GbE RJ45 (lower, vPro)` |
